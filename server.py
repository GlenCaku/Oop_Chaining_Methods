...
Glen.make_deposit(1000).make_deposit(1500).make_deposit(2000).make_withdrawal(500)
print(Glen.display_user_balance())



Rashford.make_deposit(500).make_deposit(1000).make_withdrawal(200).make_withdrawal(600)
print(Rashford.display_user_balance())

Sancho.make_deposit(1000).make_withdrawal(200).make_withdrawal(300).make_withdrawal(400)
